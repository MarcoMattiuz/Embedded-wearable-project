...
//FIFO REGISTERS
#define MAX30102_FIFO_WR_PTR_ADDR               UINT8_C(0x04) //fifo write pointer
#define MAX30102_FIFO_OVF_CTR_ADDR              UINT8_C(0x05) //fifo overflow counter
#define MAX30102_FIFO_RD_PTR_ADDR               UINT8_C(0x06) //fifo read pointer
#define MAX30102_FIFO_DATA_ADDR                 UINT8_C(0x07) //data register
...
#define MAX30102_BPM_SAMPLES_SIZE 120 /*!< The size of the buffer for the samples from sensor */
